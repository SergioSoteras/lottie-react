...
const TypedReactHooksDemo = () => {
  ...
  React.useEffect(() => {
    const options = {
    	strings: [
        'Esto es una <i>prueba</i> de typed.js',
        'Para importar <strong>componentes</strong> entre corchetes { }',
        'En vez de import Typed from "typed.js"',
        'La clase <i><strong>Typed</strong></i> ocupa unos 12 KB',
      ],
      typeSpeed: 50,
      backSpeed: 100,
    };
  ...
  return (
    <div className="wrap" style={{backgroundColor:'white',border:1,borderStyle:'solid'}}>
      <h1>Typed.js</h1>
